        ...
        <div class="col-12 col-md-8 col-lg-6">
            <form method="GET" action="products.php" class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="min_price" id="min_price" class="form-control" step="0.01" min="0" value="<?php echo htmlspecialchars($min_price); ?>">
                </div>

                <div class="col-md-4">
                    <label for="max_price" class="form-label">Max Price:</label>
                    <input type="number" name="max_price" id="max_price" class="form-control" step="0.01" min="0" value="<?php echo htmlspecialchars($max_price); ?>">
                </div>
